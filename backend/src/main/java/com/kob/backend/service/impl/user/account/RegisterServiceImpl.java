...
import com.kob.backend.service.user.account.RegisterSevice;
...
public class RegisterServiceImpl implements RegisterSevice {
    ...
    public Map<String, String> register(String username, String password, String confirmedPassword) {
        ...
        if(username ==null){
//            System.out.println("sds"+username);
...
//        System.out.println(confirmedPassword);
        ...
        if(username.length()>100||confirmedPassword.length()>100){
            map.put("error_message", "username can not be larger than 100");
            return map;
        }
