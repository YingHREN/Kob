...
export class Snake extends BotgameObject{
    constructor(info, gamemap){
        super();
        this.id = info.id;
        this.color = info.color;
        this.gamemap = gamemap;
        this.cells = [new Cell(info.r, info.c)];//存放蛇的身体，cells[0]存放
        this.next_cell = null;
        this.speed = 5;
        this.direction = -1; //-1没有指令，0,1,2,3 表示上下左右
